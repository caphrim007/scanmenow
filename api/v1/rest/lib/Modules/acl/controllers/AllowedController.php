...
* @author Tim Rupp
*/
class Acl_AllowedController extends Zend_Controller_Action {
	...
	public function indexAction() {
		...
		$username = $request->getParam('account');
		...
		try {
			...
			$allowed = $this->_helper->CanUseMethod($account->id, '/acl/allowed/index');
			if (!$allowed) {
