...
if (!function_exists('cst_autoload')) {
	function cst_autoload($class) {
		appendToPath(array(
			_ABSPATH.'/lib/'
		));
	...
	spl_autoload_register('cst_autoload');
}

if (!function_exists('appendToPath')) {
...
*/
if (!function_exists('registerClass')) {
