...
class Ini_MaintenancePlugin {
	...
	public static function get($instance = null) {
		$defaultIni = sprintf('%s/etc/default/maintenance-plugin.conf', _ABSPATH);
		$localIni = sprintf('%s/etc/local/maintenance-plugin.conf', _ABSPATH);
